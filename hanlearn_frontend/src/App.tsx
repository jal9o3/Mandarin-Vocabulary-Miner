    ...
    <div className="relative overflow-hidden">
      ...
      <main className="mx-auto min-h-screen w-full max-w-6xl px-6 pb-16 pt-8 sm:px-10 lg:px-12">
        <header className="reveal flex items-center justify-between border-b border-[#d6c7b6] pb-5">
          ...
          <button className="rounded-full border border-[#1b1714] px-5 py-2 text-sm font-semibold transition hover:-translate-y-0.5 hover:bg-[#1b1714] hover:text-white">
            Start Mining
          </button>
        </header>
        ...
        <section className="mt-12 grid items-center gap-10 lg:grid-cols-[1.25fr_1fr]">
          <div className="space-y-6">
            ...
            <div className="reveal delay-3 flex flex-wrap gap-3">
              <button className="rounded-xl bg-[#d1451b] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#d1451b]/20 transition hover:-translate-y-0.5 hover:bg-[#b63e19]">
                Upload Text
              </button>
              <button className="rounded-xl border border-[#1b1714] bg-white/80 px-6 py-3 text-sm font-semibold transition hover:-translate-y-0.5 hover:bg-white">
                Paste Passage
              </button>
            </div>
          </div>
