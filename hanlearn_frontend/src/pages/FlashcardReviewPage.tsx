...
const PLACEHOLDER_CARDS: FlashcardData[] = [
  {
    id: 1,
    word: '沉浸式',
    pronunciation: 'chénjìnshì',
    meaning: 'immersive / immersion-based',
  },
  {
    id: 2,
    word: '词汇量',
    pronunciation: 'cíhuì liàng',
    meaning: 'vocabulary size / vocabulary capacity',
  },
  {
    id: 3,
    word: '表达能力',
    pronunciation: 'biǎodá néngglì',
    meaning: 'expressive ability / ability to express',
  },
  {
    id: 4,
    word: '推敲',
    pronunciation: 'tuīqiào',
...
export function FlashcardReviewPage() {
  ...
  const currentCard = PLACEHOLDER_CARDS[currentIndex]
  const totalCards = PLACEHOLDER_CARDS.length
